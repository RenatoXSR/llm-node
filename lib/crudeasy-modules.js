...
var configComarcas = {
    ...
    labelNew:       "Novo",
    labelEdit:      "Editar",
    viewNew:        "comarcas/form.jade",
    viewItem:       "comarcas/view.jade",
    viewList:       "comarcas/list.jade",
    viewEdit:       "comarcas/form.jade",
    routeFilter:    "/filtros"
	};
var instComarcas = crudEasy.newModel(config.mongodb.url, 'comarcas');
app.use('/comarcas', isLoggedIn, crudEasy.crudRoute(instComarcas,configComarcas));
app.use('/api/comarcas', isLoggedInJson, crudEasy.apiRoute(instComarcas,configComarcas));
